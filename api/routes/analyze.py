...
- evidence에 대화를 인용할 때 이름 부분은 반드시 아래와 같이 대체하라.
  사용자가 입력한 상대방 이름 = targetname
  본인 이름 = 본인
  예) targetname이 채윤일 때 "채윤 : 지금 어디야?" → "상대방 : 지금 어디야?"
  예) targetname이 채윤일 때 "태현 : 군산 가야해서" → "본인 : 군산 가야해서"
...
{{
  ...
  "analysis_items": [
    {{
      ...
      "evidence": "인용 시 이름을 본인:/상대방: 으로 대체, 없으면 null"
    }}
  ],
  "compatibility_issues": [
    {{ "issue": "충돌 원인 (이름 금지)", "severity": "높음/중간/낮음", "detail": "설명 (100자 이내, analysis_items의 evidence에 실제 대화 인용 시 이름을 본인:/상대방: 으로 대체, 텍스트 앞 시간 삭제)" }}
  ],
